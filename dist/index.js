...
exports.uploadBuild = exports.getInputs = void 0;
const core = __importStar(__nccwpck_require__(2186));
const fs_1 = __nccwpck_require__(7147);
const axios_1 = __importDefault(__nccwpck_require__(8757));
const optionalformdata_1 = __nccwpck_require__(4635);
const apiVersion = 'v1';
 ...
 */
const fileData = () => {
    const form = new optionalformdata_1.OptionalFormData();
    form.append('file', (0, fs_1.createReadStream)(inputs.appFile));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(2186));
const appetize_1 = __nccwpck_require__(6993);
function run() {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.OptionalFormData = void 0;
const form_data_1 = __importDefault(__nccwpck_require__(4334));
class OptionalFormData extends form_data_1.default {
    appendOptional(key, value) {
        if (value) {
            this.append(key, value);
        }
    }
}
exports.OptionalFormData = OptionalFormData;
